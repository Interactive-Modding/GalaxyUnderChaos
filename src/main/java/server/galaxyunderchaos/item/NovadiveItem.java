...
public class NovadiveItem extends Item {
    public NovadiveItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (!level.isClientSide) {
            NovadiveEntity ship = new NovadiveEntity(level, pos.getX() + 0.5D, pos.getY() + 0.08D, pos.getZ() + 0.5D);
            if (player != null) {
