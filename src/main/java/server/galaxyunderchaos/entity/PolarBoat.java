...
public class PolarBoat extends Boat {
    private static final EntityDataAccessor<Integer> DATA_ID_TYPE =
            SynchedEntityData.defineId(PolarBoat.class, EntityDataSerializers.INT);

    public PolarBoat(EntityType<? extends Boat> type, Level level) {
        super(type, level);
    }

    public PolarBoat(Level level, double x, double y, double z) {
        this((EntityType<? extends Boat>) ModEntityTypes.POLAR_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case POLAR -> galaxyunderchaos.POLAR_BOAT.get();
        };
    }
    ...
    public enum Type implements StringRepresentable {
        POLAR("polar", galaxyunderchaos.POLAR_PLANKS.get());
        ...
        public static Type byName(String name) { return CODEC.byName(name, POLAR); }
