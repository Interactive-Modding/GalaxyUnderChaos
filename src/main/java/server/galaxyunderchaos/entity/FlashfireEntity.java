...
public class FlashfireEntity extends Entity implements GeoEntity, CustomizableShip {
    ...
    private static final EntityDataAccessor<Integer> CONTROLS = SynchedEntityData.defineId(FlashfireEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Float> ENGINE_POWER = SynchedEntityData.defineId(FlashfireEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> RENDER_PITCH = SynchedEntityData.defineId(FlashfireEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> RENDER_ROLL = SynchedEntityData.defineId(FlashfireEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> HEALTH = SynchedEntityData.defineId(FlashfireEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Integer> BASE_COLOR = SynchedEntityData.defineId(FlashfireEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> PRIMARY_COLOR = SynchedEntityData.defineId(FlashfireEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> SECONDARY_COLOR = SynchedEntityData.defineId(FlashfireEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> INTERIOR_COLOR = SynchedEntityData.defineId(FlashfireEntity.class, EntityDataSerializers.INT);
    ...
    public FlashfireEntity(EntityType<? extends FlashfireEntity> type, Level level) {
        super(type, level);
        this.blocksBuilding = false;
    }

    public FlashfireEntity(Level level, double x, double y, double z) {
        this(galaxyunderchaos.FLASHFIRE_ENTITY.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
...
//            this.spawnEngineParticles();
    ...
    private void destroy(DamageSource source) {
        if (this.level() instanceof ServerLevel serverLevel && serverLevel.getGameRules().getBoolean(GameRules.RULE_DOENTITYDROPS)) {
            ItemStack drop = new ItemStack(galaxyunderchaos.FLASHFIRE.get());
            ShipCustomization.saveToStack(this, drop, "flashfire");
