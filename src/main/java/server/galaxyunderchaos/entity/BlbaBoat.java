...
public class BlbaBoat extends Boat {
    private static final EntityDataAccessor<Integer> DATA_ID_TYPE =
            SynchedEntityData.defineId(BlbaBoat.class, EntityDataSerializers.INT);

    public BlbaBoat(EntityType<? extends Boat> type, Level level) {
        super(type, level);
    }

    public BlbaBoat(Level level, double x, double y, double z) {
        this((EntityType<? extends Boat>) ModEntityTypes.BLBA_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case BLBA -> galaxyunderchaos.BLBA_BOAT.get();
        };
    }
    ...
    public enum Type implements StringRepresentable {
        BLBA("blba", galaxyunderchaos.BLBA_PLANKS.get());
        ...
        public static Type byName(String name) { return CODEC.byName(name, BLBA); }
