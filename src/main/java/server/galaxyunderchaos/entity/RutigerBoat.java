...
public class RutigerBoat extends Boat {
    private static final EntityDataAccessor<Integer> DATA_ID_TYPE =
            SynchedEntityData.defineId(RutigerBoat.class, EntityDataSerializers.INT);

    public RutigerBoat(EntityType<? extends Boat> type, Level level) {
        super(type, level);
    }

    public RutigerBoat(Level level, double x, double y, double z) {
        this((EntityType<? extends Boat>) ModEntityTypes.RUTIGER_BOAT.get(), level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
        this.zo = z;
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case RUTIGER -> galaxyunderchaos.RUTIGER_BOAT.get();
        };
    }
    ...
    public enum Type implements StringRepresentable {
        RUTIGER("rutiger", galaxyunderchaos.RUTIGER_PLANKS.get());
        ...
        public static Type byName(String name) { return CODEC.byName(name, RUTIGER); }
