...
public class sith_male<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(galaxyunderchaos.MODID, "sith_male"), "main");
	...
	public sith_male(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(55, 52).addBox(1.7F, -0.4F, -4.75F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(55, 52).addBox(-2.5F, -0.6F, -4.75F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(55, 52).addBox(-0.5F, -0.4F, -3.85F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -12.0F, -2.0F));
		...
		.texOffs(55, 53).addBox(4.2F, -5.0F, -3.25F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.5F, 1.7F, -2.0F, -0.3491F, 0.0F, 0.0F));
