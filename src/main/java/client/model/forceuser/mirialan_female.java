...
public class mirialan_female<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(galaxyunderchaos.MODID, "mirialan_female"), "main");
	...
	public mirialan_female(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Torso.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(60, 14).addBox(-5.0F, -8.0F, -4.0F, 1.0F, 8.0F, 9.0F, new CubeDeformation(0.0F))
		.texOffs(60, 14).addBox(4.0F, -8.0F, -4.0F, 1.0F, 8.0F, 9.0F, new CubeDeformation(0.0F))
		.texOffs(62, 47).addBox(-4.0F, -8.0F, 4.0F, 8.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(17, 58).addBox(-4.0F, 0.0F, 2.0F, 8.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(42, 70).addBox(-5.0F, -9.0F, -4.0F, 10.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -12.0F, -2.0F));
		...
		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(44, 40).addBox(-1.0F, -0.5F, -0.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -5.5F, -3.9F, 0.0F, 0.0873F, 0.0F));

		PartDefinition cube_r3 = Head.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(44, 38).addBox(-1.0F, -0.5F, -0.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -5.5F, -4.0F, 0.0F, -0.0873F, 0.0F));
