...
public class twilek_female<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(galaxyunderchaos.MODID, "twilek_female"), "main");
	...
	public twilek_female(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r3 = Head.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(2, 0).addBox(-1.0F, -0.5F, -4.0F, 2.0F, 1.0F, 8.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(-3.3119F, -8.1204F, 0.0F, 0.0F, 0.0F, -0.48F));
		...
		PartDefinition leftBackAppendage = Head.addOrReplaceChild("leftBackAppendage", CubeListBuilder.create(), PartPose.offsetAndRotation(-2.7106F, -7.3016F, -1.3651F, 0.9475F, 1.6015F, 1.5441F));
		...
		PartDefinition cube_r5 = leftBackAppendageBottom.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(35, 69).addBox(-1.0F, -4.0F, -1.5F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.75F, 3.0F, 2.25F, 0.2285F, 0.0594F, -0.0485F));

		PartDefinition leftBackAppendage2 = Head.addOrReplaceChild("leftBackAppendage2", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.5106F, -6.9016F, 1.3349F, 1.415F, 1.1044F, 1.8112F));

		PartDefinition cube_r6 = leftBackAppendage2.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(18, 60).addBox(-2.0F, -5.0F, -1.5F, 4.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5124F, 4.1094F, 0.0151F, -0.1719F, 0.0302F, -0.2208F));

		PartDefinition leftBackAppendageBottom2 = leftBackAppendage2.addOrReplaceChild("leftBackAppendageBottom2", CubeListBuilder.create(), PartPose.offset(3.8001F, 7.2178F, -1.8954F));

		PartDefinition cube_r7 = leftBackAppendageBottom2.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(34, 69).addBox(-2.0F, -4.0F, -1.5F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.75F, 3.0F, 2.25F, 0.2285F, 0.0594F, -0.0485F));
