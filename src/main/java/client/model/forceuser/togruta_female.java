...
public class togruta_female<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(galaxyunderchaos.MODID, "togruta_female"), "main");
	...
	public togruta_female (ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(70, 0).addBox(-2.25F, -1.0F, -1.5F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.7261F, -13.4346F, 5.5307F, -0.3655F, -0.147F, -0.7582F));
		...
		PartDefinition cube_r10 = leftFrontAppendageBottom.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(64, 40).addBox(-2.0F, -4.0F, -1.5F, 4.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.75F, 3.0F, -2.25F, -0.2285F, -0.0594F, -0.0485F));
		...
		PartDefinition cube_r11 = BackAppendageTop.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(0, 36).addBox(-4.0F, -2.0F, -3.5F, 3.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.6648F, 2.3755F, 0.0F, 0.0F, 0.0F, 0.0873F));
		...
		PartDefinition cube_r12 = BackAppendageMiddle.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(0, 61).addBox(-4.0F, 6.0F, -2.5F, 3.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.4813F, -5.5998F, 0.0F, 0.0F, 0.0F, 0.0873F));
		...
		PartDefinition cube_r13 = BackAppendageBottom.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(48, 70).addBox(-1.5F, -2.5F, -1.5F, 2.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.9881F, 2.1418F, 0.0F, 0.0F, 0.0F, -0.2182F));
		...
		PartDefinition cube_r15 = leftBackAppendageBottom.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(34, 69).addBox(-2.0F, -4.0F, -1.5F, 4.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.75F, 3.0F, 2.25F, 0.2285F, 0.0594F, -0.0485F));
