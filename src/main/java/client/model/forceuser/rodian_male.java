...
public class rodian_male<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(galaxyunderchaos.MODID, "rodian_male"), "main");
	...
	public rodian_male(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(0, 0).addBox(-3.3119F, -8.0204F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(-0.001F)), PartPose.offset(-0.6881F, -5.9796F, 0.0F));
