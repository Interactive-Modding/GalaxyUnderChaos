...
public class zabrak_female<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(galaxyunderchaos.MODID, "zabrak_female"), "main");
	...
	public zabrak_female(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(20, 36).addBox(-0.75F, -2.0F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.001F))
		...
		PartDefinition cube_r4 = Head.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(20, 36).addBox(-0.75F, -2.0F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.001F))
		.texOffs(20, 36).addBox(-0.75F, -2.0F, 5.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(4.1881F, -4.5204F, -3.0F, 0.0F, 0.0F, 0.6109F));
		...
		.texOffs(20, 36).addBox(-0.75F, -2.0F, -4.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(4.1881F, -5.5204F, 2.0F, 0.0F, 0.0F, 0.6109F));
		...
		PartDefinition cube_r7 = Head.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(45, 54).addBox(-0.75F, -2.0F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.001F)), PartPose.offsetAndRotation(4.9381F, -2.2704F, 0.0F, 0.0F, 0.0F, -0.3491F));
