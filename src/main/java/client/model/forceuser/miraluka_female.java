...
public class miraluka_female<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(galaxyunderchaos.MODID, "miraluka_female"), "main");
	...
	public miraluka_female(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(16, 59).addBox(-4.05F, -6.0F, 3.25F, 8.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(16, 61).addBox(-1.0F, -6.0F, -4.25F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -12.0F, -2.0F));
		...
		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(16, 59).addBox(-2.0F, -0.5F, -0.25F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -5.5F, -4.1F, 0.0F, 0.1309F, 0.0F));

		PartDefinition cube_r3 = Head.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(16, 59).addBox(-1.0F, -0.5F, -0.25F, 8.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.55F, -5.5F, -3.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r4 = Head.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(16, 59).addBox(-1.0F, -0.5F, -0.25F, 8.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.05F, -5.5F, -3.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition cube_r5 = Head.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(16, 59).addBox(-1.0F, -0.5F, -0.25F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -5.5F, -4.0F, 0.0F, -0.1309F, 0.0F));
