 ...
 */
public class ModelBodyArena extends LegacyModelBase {
    ...
    public ModelBodyArena() {
        this.textureWidth = 64;
        this.textureHeight = 32;
        this.upperConnector3 = new LegacyModelRenderer(this, 48, 1);
        this.upperConnector3.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.upperConnector3.addBox(-1.5F, -1.0F, 2.62F, 3, 21, 1, 0.0F);
        this.setRotateAngle(upperConnector3, 0.0F, 1.5707963267948966F, 0.0F);
        this.upperConnector4 = new LegacyModelRenderer(this, 28, 1);
        this.upperConnector4.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.upperConnector4.addBox(-1.5F, -1.0F, 2.62F, 3, 21, 1, 0.0F);
        this.setRotateAngle(upperConnector4, 0.0F, 2.356194490192345F, 0.0F);
        this.upperConnector7 = new LegacyModelRenderer(this, 38, 1);
        this.upperConnector7.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.upperConnector7.addBox(-1.5F, -1.0F, 2.62F, 3, 21, 1, 0.0F);
        ...
        this.upperConnector2 = new LegacyModelRenderer(this, 38, 1);
        this.upperConnector2.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.upperConnector2.addBox(-1.5F, -1.0F, 2.62F, 3, 21, 1, 0.0F);
        ...
        this.upperConnector6 = new LegacyModelRenderer(this, 38, 1);
        this.upperConnector6.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.upperConnector6.addBox(-1.5F, -1.0F, 2.62F, 3, 21, 1, 0.0F);
        ...
        this.upperConnector8 = new LegacyModelRenderer(this, 38, 1);
        this.upperConnector8.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.upperConnector8.addBox(-1.5F, -1.0F, 2.62F, 3, 21, 1, 0.0F);
        ...
        this.button1.setRotationPoint(3.0F, 8.4F, 0.0F);
        this.button1.addBox(-1.5F, -5.0F, -0.38F, 3, 5, 4, 0.0F);
        this.setRotateAngle(button1, 0.0F, 1.5707963267948966F, 1.5707963267948966F);
        ...
        this.upperConnector1 = new LegacyModelRenderer(this, 38, 1);
        this.upperConnector1.setRotationPoint(0.0F, 0.7F, 0.0F);
        this.upperConnector1.addBox(-1.5F, -1.0F, 2.62F, 3, 21, 1, 0.0F);
        ...
        this.button1.addChild(this.button1_1);
