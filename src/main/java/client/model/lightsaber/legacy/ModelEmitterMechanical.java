...
public class ModelEmitterMechanical extends LegacyModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LegacyGL.glTranslatef(guard3.offsetX, guard3.offsetY, guard3.offsetZ);
        LegacyGL.glTranslatef(guard3.rotationPointX * f5, guard3.rotationPointY * f5, guard3.rotationPointZ * f5);
        LegacyGL.glScaled(1.04D, 1.0D, 1.0D);
        LegacyGL.glTranslatef(-guard3.offsetX, -guard3.offsetY, -guard3.offsetZ);
        LegacyGL.glTranslatef(-guard3.rotationPointX * f5, -guard3.rotationPointY * f5, -guard3.rotationPointZ * f5);
        guard3.render(f5);
        ...
        guard5.render(f5);
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(frontButton1.offsetX, frontButton1.offsetY, frontButton1.offsetZ);
        LegacyGL.glTranslatef(frontButton1.rotationPointX * f5, frontButton1.rotationPointY * f5, frontButton1.rotationPointZ * f5);
