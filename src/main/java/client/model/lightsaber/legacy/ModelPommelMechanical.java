...
public class ModelPommelMechanical extends LegacyModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LegacyGL.glTranslatef(body1_1.offsetX, body1_1.offsetY, body1_1.offsetZ);
        LegacyGL.glTranslatef(body1_1.rotationPointX * f5, body1_1.rotationPointY * f5, body1_1.rotationPointZ * f5);
        LegacyGL.glScaled(1.0D, 0.5D, 1.0D);
        LegacyGL.glTranslatef(-body1_1.offsetX, -body1_1.offsetY, -body1_1.offsetZ);
        LegacyGL.glTranslatef(-body1_1.rotationPointX * f5, -body1_1.rotationPointY * f5, -body1_1.rotationPointZ * f5);
        body1_1.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(body1_2.offsetX, body1_2.offsetY, body1_2.offsetZ);
        LegacyGL.glTranslatef(body1_2.rotationPointX * f5, body1_2.rotationPointY * f5, body1_2.rotationPointZ * f5);
        LegacyGL.glScaled(1.0D, 0.5D, 1.0D);
        LegacyGL.glTranslatef(-body1_2.offsetX, -body1_2.offsetY, -body1_2.offsetZ);
        LegacyGL.glTranslatef(-body1_2.rotationPointX * f5, -body1_2.rotationPointY * f5, -body1_2.rotationPointZ * f5);
        body1_2.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(top1_1.offsetX, top1_1.offsetY, top1_1.offsetZ);
        LegacyGL.glTranslatef(top1_1.rotationPointX * f5, top1_1.rotationPointY * f5, top1_1.rotationPointZ * f5);
