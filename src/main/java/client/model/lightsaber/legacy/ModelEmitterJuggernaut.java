...
public class ModelEmitterJuggernaut extends LegacyModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LegacyGL.glScaled(0.9D, 0.9D, 1.0D);
        LegacyGL.glTranslatef(-ring2_1.offsetX, -ring2_1.offsetY, -ring2_1.offsetZ);
        LegacyGL.glTranslatef(-ring2_1.rotationPointX * f5, -ring2_1.rotationPointY * f5, -ring2_1.rotationPointZ * f5);
        ring2_1.render(f5);
        LegacyGL.glPopMatrix();
        ...
        LegacyGL.glScaled(0.8D, 0.8D, 0.73D);
        LegacyGL.glTranslatef(-ring1_1.offsetX, -ring1_1.offsetY, -ring1_1.offsetZ);
        LegacyGL.glTranslatef(-ring1_1.rotationPointX * f5, -ring1_1.rotationPointY * f5, -ring1_1.rotationPointZ * f5);
        ring1_1.render(f5);
        LegacyGL.glPopMatrix();
        ...
        body1.render(f5);
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(leftGuardEdge1.offsetX, leftGuardEdge1.offsetY, leftGuardEdge1.offsetZ);
        LegacyGL.glTranslatef(leftGuardEdge1.rotationPointX * f5, leftGuardEdge1.rotationPointY * f5, leftGuardEdge1.rotationPointZ * f5);
        LegacyGL.glScaled(1.0D, 1.0D, 1.2D);
        LegacyGL.glTranslatef(-leftGuardEdge1.offsetX, -leftGuardEdge1.offsetY, -leftGuardEdge1.offsetZ);
        LegacyGL.glTranslatef(-leftGuardEdge1.rotationPointX * f5, -leftGuardEdge1.rotationPointY * f5, -leftGuardEdge1.rotationPointZ * f5);
        leftGuardEdge1.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(frontButtonRing1.offsetX, frontButtonRing1.offsetY, frontButtonRing1.offsetZ);
        LegacyGL.glTranslatef(frontButtonRing1.rotationPointX * f5, frontButtonRing1.rotationPointY * f5, frontButtonRing1.rotationPointZ * f5);
        LegacyGL.glScaled(0.38D, 0.38D, 0.38D);
        LegacyGL.glTranslatef(-frontButtonRing1.offsetX, -frontButtonRing1.offsetY, -frontButtonRing1.offsetZ);
        LegacyGL.glTranslatef(-frontButtonRing1.rotationPointX * f5, -frontButtonRing1.rotationPointY * f5, -frontButtonRing1.rotationPointZ * f5);
        ...
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(rightGuardEdge1.offsetX, rightGuardEdge1.offsetY, rightGuardEdge1.offsetZ);
        LegacyGL.glTranslatef(rightGuardEdge1.rotationPointX * f5, rightGuardEdge1.rotationPointY * f5, rightGuardEdge1.rotationPointZ * f5);
        LegacyGL.glScaled(1.0D, 1.0D, 1.2D);
        LegacyGL.glTranslatef(-rightGuardEdge1.offsetX, -rightGuardEdge1.offsetY, -rightGuardEdge1.offsetZ);
        LegacyGL.glTranslatef(-rightGuardEdge1.rotationPointX * f5, -rightGuardEdge1.rotationPointY * f5, -rightGuardEdge1.rotationPointZ * f5);
