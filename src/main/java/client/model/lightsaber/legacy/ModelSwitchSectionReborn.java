...
public class ModelSwitchSectionReborn extends LegacyModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LegacyGL.glTranslatef(sideRing1.offsetX, sideRing1.offsetY, sideRing1.offsetZ);
        LegacyGL.glTranslatef(sideRing1.rotationPointX * f5, sideRing1.rotationPointY * f5, sideRing1.rotationPointZ * f5);
        ...
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(sideRing2_2.offsetX, sideRing2_2.offsetY, sideRing2_2.offsetZ);
        LegacyGL.glTranslatef(sideRing2_2.rotationPointX * f5, sideRing2_2.rotationPointY * f5, sideRing2_2.rotationPointZ * f5);
        LegacyGL.glScaled(1.01D, 0.5D, 1.01D);
        LegacyGL.glTranslatef(-sideRing2_2.offsetX, -sideRing2_2.offsetY, -sideRing2_2.offsetZ);
        LegacyGL.glTranslatef(-sideRing2_2.rotationPointX * f5, -sideRing2_2.rotationPointY * f5, -sideRing2_2.rotationPointZ * f5);
        sideRing2_2.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(sideRing2.offsetX, sideRing2.offsetY, sideRing2.offsetZ);
        LegacyGL.glTranslatef(sideRing2.rotationPointX * f5, sideRing2.rotationPointY * f5, sideRing2.rotationPointZ * f5);
        LegacyGL.glScaled(1.01D, 0.5D, 1.01D);
        LegacyGL.glTranslatef(-sideRing2.offsetX, -sideRing2.offsetY, -sideRing2.offsetZ);
        LegacyGL.glTranslatef(-sideRing2.rotationPointX * f5, -sideRing2.rotationPointY * f5, -sideRing2.rotationPointZ * f5);
        sideRing2.render(f5);
        ...
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(topRing12.offsetX, topRing12.offsetY, topRing12.offsetZ);
        LegacyGL.glTranslatef(topRing12.rotationPointX * f5, topRing12.rotationPointY * f5, topRing12.rotationPointZ * f5);
        LegacyGL.glScaled(0.5D, 0.5D, 1.0D);
        LegacyGL.glTranslatef(-topRing12.offsetX, -topRing12.offsetY, -topRing12.offsetZ);
        LegacyGL.glTranslatef(-topRing12.rotationPointX * f5, -topRing12.rotationPointY * f5, -topRing12.rotationPointZ * f5);
        topRing12.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(button1Point2.offsetX, button1Point2.offsetY, button1Point2.offsetZ);
        LegacyGL.glTranslatef(button1Point2.rotationPointX * f5, button1Point2.rotationPointY * f5, button1Point2.rotationPointZ * f5);
        LegacyGL.glScaled(0.2D, 0.2D, 0.25D);
        LegacyGL.glTranslatef(-button1Point2.offsetX, -button1Point2.offsetY, -button1Point2.offsetZ);
        LegacyGL.glTranslatef(-button1Point2.rotationPointX * f5, -button1Point2.rotationPointY * f5, -button1Point2.rotationPointZ * f5);
        button1Point2.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(topRing12_2.offsetX, topRing12_2.offsetY, topRing12_2.offsetZ);
        LegacyGL.glTranslatef(topRing12_2.rotationPointX * f5, topRing12_2.rotationPointY * f5, topRing12_2.rotationPointZ * f5);
        LegacyGL.glScaled(0.5D, 0.5D, 0.5D);
        LegacyGL.glTranslatef(-topRing12_2.offsetX, -topRing12_2.offsetY, -topRing12_2.offsetZ);
        LegacyGL.glTranslatef(-topRing12_2.rotationPointX * f5, -topRing12_2.rotationPointY * f5, -topRing12_2.rotationPointZ * f5);
        topRing12_2.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(topRing12_1.offsetX, topRing12_1.offsetY, topRing12_1.offsetZ);
        LegacyGL.glTranslatef(topRing12_1.rotationPointX * f5, topRing12_1.rotationPointY * f5, topRing12_1.rotationPointZ * f5);
        LegacyGL.glScaled(0.5D, 0.5D, 0.5D);
        LegacyGL.glTranslatef(-topRing12_1.offsetX, -topRing12_1.offsetY, -topRing12_1.offsetZ);
        LegacyGL.glTranslatef(-topRing12_1.rotationPointX * f5, -topRing12_1.rotationPointY * f5, -topRing12_1.rotationPointZ * f5);
        ...
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(topRing10.offsetX, topRing10.offsetY, topRing10.offsetZ);
        LegacyGL.glTranslatef(topRing10.rotationPointX * f5, topRing10.rotationPointY * f5, topRing10.rotationPointZ * f5);
        LegacyGL.glScaled(0.5D, 1.0D, 1.0D);
        LegacyGL.glTranslatef(-topRing10.offsetX, -topRing10.offsetY, -topRing10.offsetZ);
        LegacyGL.glTranslatef(-topRing10.rotationPointX * f5, -topRing10.rotationPointY * f5, -topRing10.rotationPointZ * f5);
        topRing10.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(button1Point1.offsetX, button1Point1.offsetY, button1Point1.offsetZ);
        LegacyGL.glTranslatef(button1Point1.rotationPointX * f5, button1Point1.rotationPointY * f5, button1Point1.rotationPointZ * f5);
        LegacyGL.glScaled(0.25D, 0.25D, 0.25D);
        LegacyGL.glTranslatef(-button1Point1.offsetX, -button1Point1.offsetY, -button1Point1.offsetZ);
        LegacyGL.glTranslatef(-button1Point1.rotationPointX * f5, -button1Point1.rotationPointY * f5, -button1Point1.rotationPointZ * f5);
        ...
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(topRing11.offsetX, topRing11.offsetY, topRing11.offsetZ);
        LegacyGL.glTranslatef(topRing11.rotationPointX * f5, topRing11.rotationPointY * f5, topRing11.rotationPointZ * f5);
        LegacyGL.glScaled(0.5D, 0.5D, 1.0D);
        LegacyGL.glTranslatef(-topRing11.offsetX, -topRing11.offsetY, -topRing11.offsetZ);
        LegacyGL.glTranslatef(-topRing11.rotationPointX * f5, -topRing11.rotationPointY * f5, -topRing11.rotationPointZ * f5);
        topRing11.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(sideRing2_1.offsetX, sideRing2_1.offsetY, sideRing2_1.offsetZ);
        LegacyGL.glTranslatef(sideRing2_1.rotationPointX * f5, sideRing2_1.rotationPointY * f5, sideRing2_1.rotationPointZ * f5);
        LegacyGL.glScaled(1.01D, 0.5D, 1.01D);
        LegacyGL.glTranslatef(-sideRing2_1.offsetX, -sideRing2_1.offsetY, -sideRing2_1.offsetZ);
        LegacyGL.glTranslatef(-sideRing2_1.rotationPointX * f5, -sideRing2_1.rotationPointY * f5, -sideRing2_1.rotationPointZ * f5);
        ...
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(sideRing2_3.offsetX, sideRing2_3.offsetY, sideRing2_3.offsetZ);
        LegacyGL.glTranslatef(sideRing2_3.rotationPointX * f5, sideRing2_3.rotationPointY * f5, sideRing2_3.rotationPointZ * f5);
        LegacyGL.glScaled(1.01D, 0.5D, 1.01D);
        LegacyGL.glTranslatef(-sideRing2_3.offsetX, -sideRing2_3.offsetY, -sideRing2_3.offsetZ);
        LegacyGL.glTranslatef(-sideRing2_3.rotationPointX * f5, -sideRing2_3.rotationPointY * f5, -sideRing2_3.rotationPointZ * f5);
        ...
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(topRing9.offsetX, topRing9.offsetY, topRing9.offsetZ);
        LegacyGL.glTranslatef(topRing9.rotationPointX * f5, topRing9.rotationPointY * f5, topRing9.rotationPointZ * f5);
        LegacyGL.glScaled(0.5D, 1.0D, 1.0D);
        LegacyGL.glTranslatef(-topRing9.offsetX, -topRing9.offsetY, -topRing9.offsetZ);
        LegacyGL.glTranslatef(-topRing9.rotationPointX * f5, -topRing9.rotationPointY * f5, -topRing9.rotationPointZ * f5);
        topRing9.render(f5);
