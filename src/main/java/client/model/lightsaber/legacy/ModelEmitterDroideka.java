...
public class ModelEmitterDroideka extends LegacyModelBase
{
    ...
    public ModelEmitterDroideka()
    {
        ...
        ring6 = new LegacyModelRenderer(this, 0, 5);
        ...
        ring3 = new LegacyModelRenderer(this, 0, 5);
        ...
        ring8 = new LegacyModelRenderer(this, 0, 5);
        ...
        ring7 = new LegacyModelRenderer(this, 0, 5);
        ...
        ring5 = new LegacyModelRenderer(this, 0, 5);
        ...
        ring2 = new LegacyModelRenderer(this, 0, 5);
        ...
        ring1 = new LegacyModelRenderer(this, 0, 5);
        ...
        ring4 = new LegacyModelRenderer(this, 0, 5);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LegacyGL.glScaled(1.2D, 1.2D, 1.2D);
        LegacyGL.glTranslatef(-ring1.offsetX, -ring1.offsetY, -ring1.offsetZ);
        LegacyGL.glTranslatef(-ring1.rotationPointX * f5, -ring1.rotationPointY * f5, -ring1.rotationPointZ * f5);
        ring1.render(f5);
