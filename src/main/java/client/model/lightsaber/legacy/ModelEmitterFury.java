...
public class ModelEmitterFury extends LegacyModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LegacyGL.glTranslatef(backPlate1.offsetX, backPlate1.offsetY, backPlate1.offsetZ);
        LegacyGL.glTranslatef(backPlate1.rotationPointX * f5, backPlate1.rotationPointY * f5, backPlate1.rotationPointZ * f5);
        LegacyGL.glScaled(0.82D, 0.82D, 0.7D);
        LegacyGL.glTranslatef(-backPlate1.offsetX, -backPlate1.offsetY, -backPlate1.offsetZ);
        LegacyGL.glTranslatef(-backPlate1.rotationPointX * f5, -backPlate1.rotationPointY * f5, -backPlate1.rotationPointZ * f5);
        ...
        LegacyGL.glScaled(0.81D, 1.0D, 0.81D);
        LegacyGL.glTranslatef(-innerRing1.offsetX, -innerRing1.offsetY, -innerRing1.offsetZ);
        LegacyGL.glTranslatef(-innerRing1.rotationPointX * f5, -innerRing1.rotationPointY * f5, -innerRing1.rotationPointZ * f5);
        ...
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(darkInnerRing1.offsetX, darkInnerRing1.offsetY, darkInnerRing1.offsetZ);
        LegacyGL.glTranslatef(darkInnerRing1.rotationPointX * f5, darkInnerRing1.rotationPointY * f5, darkInnerRing1.rotationPointZ * f5);
        ...
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(topDetail1.offsetX, topDetail1.offsetY, topDetail1.offsetZ);
        LegacyGL.glTranslatef(topDetail1.rotationPointX * f5, topDetail1.rotationPointY * f5, topDetail1.rotationPointZ * f5);
        LegacyGL.glScaled(0.77D, 0.5D, 0.7D);
        LegacyGL.glTranslatef(-topDetail1.offsetX, -topDetail1.offsetY, -topDetail1.offsetZ);
        LegacyGL.glTranslatef(-topDetail1.rotationPointX * f5, -topDetail1.rotationPointY * f5, -topDetail1.rotationPointZ * f5);
        ...
        LegacyGL.glScaled(0.65D, 0.65D, 0.65D);
        LegacyGL.glTranslatef(-emitterRing1.offsetX, -emitterRing1.offsetY, -emitterRing1.offsetZ);
        LegacyGL.glTranslatef(-emitterRing1.rotationPointX * f5, -emitterRing1.rotationPointY * f5, -emitterRing1.rotationPointZ * f5);
        ...
        LegacyGL.glScaled(0.8D, 0.8D, 0.8D);
        LegacyGL.glTranslatef(-upperRing1.offsetX, -upperRing1.offsetY, -upperRing1.offsetZ);
        LegacyGL.glTranslatef(-upperRing1.rotationPointX * f5, -upperRing1.rotationPointY * f5, -upperRing1.rotationPointZ * f5);
