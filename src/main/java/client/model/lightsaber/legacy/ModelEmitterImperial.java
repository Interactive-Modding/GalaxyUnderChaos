...
public class ModelEmitterImperial extends LegacyModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LegacyGL.glTranslatef(topRing1.offsetX, topRing1.offsetY, topRing1.offsetZ);
        LegacyGL.glTranslatef(topRing1.rotationPointX * f5, topRing1.rotationPointY * f5, topRing1.rotationPointZ * f5);
        LegacyGL.glScaled(0.9D, 0.6D, 0.9D);
        LegacyGL.glTranslatef(-topRing1.offsetX, -topRing1.offsetY, -topRing1.offsetZ);
        LegacyGL.glTranslatef(-topRing1.rotationPointX * f5, -topRing1.rotationPointY * f5, -topRing1.rotationPointZ * f5);
        topRing1.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(topRing1_1.offsetX, topRing1_1.offsetY, topRing1_1.offsetZ);
        LegacyGL.glTranslatef(topRing1_1.rotationPointX * f5, topRing1_1.rotationPointY * f5, topRing1_1.rotationPointZ * f5);
        LegacyGL.glScaled(0.9D, 0.9D, 0.9D);
        LegacyGL.glTranslatef(-topRing1_1.offsetX, -topRing1_1.offsetY, -topRing1_1.offsetZ);
        LegacyGL.glTranslatef(-topRing1_1.rotationPointX * f5, -topRing1_1.rotationPointY * f5, -topRing1_1.rotationPointZ * f5);
        topRing1_1.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(emitterRing1.offsetX, emitterRing1.offsetY, emitterRing1.offsetZ);
        LegacyGL.glTranslatef(emitterRing1.rotationPointX * f5, emitterRing1.rotationPointY * f5, emitterRing1.rotationPointZ * f5);
        LegacyGL.glScaled(-0.45D, 0.65D, -0.45D);
        LegacyGL.glTranslatef(-emitterRing1.offsetX, -emitterRing1.offsetY, -emitterRing1.offsetZ);
        LegacyGL.glTranslatef(-emitterRing1.rotationPointX * f5, -emitterRing1.rotationPointY * f5, -emitterRing1.rotationPointZ * f5);
        emitterRing1.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(upperRing1.offsetX, upperRing1.offsetY, upperRing1.offsetZ);
        LegacyGL.glTranslatef(upperRing1.rotationPointX * f5, upperRing1.rotationPointY * f5, upperRing1.rotationPointZ * f5);
        LegacyGL.glScaled(0.5D, 0.8D, 0.5D);
        LegacyGL.glTranslatef(-upperRing1.offsetX, -upperRing1.offsetY, -upperRing1.offsetZ);
        LegacyGL.glTranslatef(-upperRing1.rotationPointX * f5, -upperRing1.rotationPointY * f5, -upperRing1.rotationPointZ * f5);
        ...
        LegacyGL.glScaled(0.81D, 0.9D, 0.81D);
        LegacyGL.glTranslatef(-innerRing1.offsetX, -innerRing1.offsetY, -innerRing1.offsetZ);
        LegacyGL.glTranslatef(-innerRing1.rotationPointX * f5, -innerRing1.rotationPointY * f5, -innerRing1.rotationPointZ * f5);
