...
public class ModelSwitchSectionKnighted extends LegacyModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(button1.offsetX, button1.offsetY, button1.offsetZ);
        LegacyGL.glTranslatef(button1.rotationPointX * f5, button1.rotationPointY * f5, button1.rotationPointZ * f5);
        LegacyGL.glScaled(0.25D, 0.13D, 0.13D);
        LegacyGL.glTranslatef(-button1.offsetX, -button1.offsetY, -button1.offsetZ);
        LegacyGL.glTranslatef(-button1.rotationPointX * f5, -button1.rotationPointY * f5, -button1.rotationPointZ * f5);
        button1.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(shell1.offsetX, shell1.offsetY, shell1.offsetZ);
        LegacyGL.glTranslatef(shell1.rotationPointX * f5, shell1.rotationPointY * f5, shell1.rotationPointZ * f5);
        LegacyGL.glScaled(1.35D, 1.35D, 1.35D);
        LegacyGL.glTranslatef(-shell1.offsetX, -shell1.offsetY, -shell1.offsetZ);
        LegacyGL.glTranslatef(-shell1.rotationPointX * f5, -shell1.rotationPointY * f5, -shell1.rotationPointZ * f5);
        shell1.render(f5);
        LegacyGL.glPopMatrix();
