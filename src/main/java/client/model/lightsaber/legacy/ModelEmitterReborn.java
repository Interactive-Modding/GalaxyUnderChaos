...
public class ModelEmitterReborn extends LegacyModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(sideRing3.offsetX, sideRing3.offsetY, sideRing3.offsetZ);
        LegacyGL.glTranslatef(sideRing3.rotationPointX * f5, sideRing3.rotationPointY * f5, sideRing3.rotationPointZ * f5);
        LegacyGL.glScaled(1.1D, 2.0D, 1.1D);
        LegacyGL.glTranslatef(-sideRing3.offsetX, -sideRing3.offsetY, -sideRing3.offsetZ);
        LegacyGL.glTranslatef(-sideRing3.rotationPointX * f5, -sideRing3.rotationPointY * f5, -sideRing3.rotationPointZ * f5);
        sideRing3.render(f5);
        LegacyGL.glPopMatrix();
        ...
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(emitterTip1.offsetX, emitterTip1.offsetY, emitterTip1.offsetZ);
        LegacyGL.glTranslatef(emitterTip1.rotationPointX * f5, emitterTip1.rotationPointY * f5, emitterTip1.rotationPointZ * f5);
        LegacyGL.glScaled(-0.37D, 0.93D, -0.37D);
        LegacyGL.glTranslatef(-emitterTip1.offsetX, -emitterTip1.offsetY, -emitterTip1.offsetZ);
        LegacyGL.glTranslatef(-emitterTip1.rotationPointX * f5, -emitterTip1.rotationPointY * f5, -emitterTip1.rotationPointZ * f5);
        ...
        LegacyGL.glScaled(0.63D, 0.53D, 0.63D);
        LegacyGL.glTranslatef(-darkInnerRing1.offsetX, -darkInnerRing1.offsetY, -darkInnerRing1.offsetZ);
        LegacyGL.glTranslatef(-darkInnerRing1.rotationPointX * f5, -darkInnerRing1.rotationPointY * f5, -darkInnerRing1.rotationPointZ * f5);
        ...
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(sideRing4.offsetX, sideRing4.offsetY, sideRing4.offsetZ);
        LegacyGL.glTranslatef(sideRing4.rotationPointX * f5, sideRing4.rotationPointY * f5, sideRing4.rotationPointZ * f5);
        LegacyGL.glScaled(1.1D, 2.0D, 1.1D);
        LegacyGL.glTranslatef(-sideRing4.offsetX, -sideRing4.offsetY, -sideRing4.offsetZ);
        LegacyGL.glTranslatef(-sideRing4.rotationPointX * f5, -sideRing4.rotationPointY * f5, -sideRing4.rotationPointZ * f5);
        sideRing4.render(f5);
