...
//        topConnector1.isHidden = true;
        ...
        LegacyGL.glTranslatef(button2_1.offsetX, button2_1.offsetY, button2_1.offsetZ);
        LegacyGL.glTranslatef(button2_1.rotationPointX * f5, button2_1.rotationPointY * f5, button2_1.rotationPointZ * f5);
        ...
        body1.render(f5);
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(button1_1.offsetX, button1_1.offsetY, button1_1.offsetZ);
        LegacyGL.glTranslatef(button1_1.rotationPointX * f5, button1_1.rotationPointY * f5, button1_1.rotationPointZ * f5);
        LegacyGL.glScaled(0.3D, 0.3D, 0.3D);
        LegacyGL.glTranslatef(-button1_1.offsetX, -button1_1.offsetY, -button1_1.offsetZ);
        LegacyGL.glTranslatef(-button1_1.rotationPointX * f5, -button1_1.rotationPointY * f5, -button1_1.rotationPointZ * f5);
        button1_1.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(topConnector1.offsetX, topConnector1.offsetY, topConnector1.offsetZ);
        LegacyGL.glTranslatef(topConnector1.rotationPointX * f5, topConnector1.rotationPointY * f5, topConnector1.rotationPointZ * f5);
        ...
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(bottomConnector1.offsetX, bottomConnector1.offsetY, bottomConnector1.offsetZ);
        LegacyGL.glTranslatef(bottomConnector1.rotationPointX * f5, bottomConnector1.rotationPointY * f5, bottomConnector1.rotationPointZ * f5);
        LegacyGL.glScaled(0.9D, 0.9D, 0.9D);
        LegacyGL.glTranslatef(-bottomConnector1.offsetX, -bottomConnector1.offsetY, -bottomConnector1.offsetZ);
        LegacyGL.glTranslatef(-bottomConnector1.rotationPointX * f5, -bottomConnector1.rotationPointY * f5, -bottomConnector1.rotationPointZ * f5);
