...
public class ModelSwitchSectionVaid extends LegacyModelBase
{
    public LegacyModelRenderer body1;
    public LegacyModelRenderer upperButton1;
    public LegacyModelRenderer lowerButton1;
    ...
    public LegacyModelRenderer upperButton2;
    public LegacyModelRenderer upperButton3;
    public LegacyModelRenderer upperButton4;
    public LegacyModelRenderer upperButton5;
    public LegacyModelRenderer upperButton6;
    public LegacyModelRenderer upperButton7;
    public LegacyModelRenderer upperButton8;
    public LegacyModelRenderer lowerButton2;
    public LegacyModelRenderer lowerButton3;
    public LegacyModelRenderer lowerButton4;
    public LegacyModelRenderer lowerButton5;
    public LegacyModelRenderer lowerButton6;
    public LegacyModelRenderer lowerButton7;
    public LegacyModelRenderer lowerButton8;

    public ModelSwitchSectionVaid()
    {
        textureWidth = 64;
        textureHeight = 32;
        upperButton6 = new LegacyModelRenderer(this, 8, 0);
        ...
        lowerButton5 = new LegacyModelRenderer(this, 0, 9);
        ...
        upperButton8 = new LegacyModelRenderer(this, 8, 0);
        ...
        upperButton2 = new LegacyModelRenderer(this, 8, 0);
        ...
        upperButton3 = new LegacyModelRenderer(this, 8, 0);
        ...
        upperButton7 = new LegacyModelRenderer(this, 8, 0);
        ...
        lowerButton7 = new LegacyModelRenderer(this, 0, 9);
        ...
        lowerButton6 = new LegacyModelRenderer(this, 0, 9);
        ...
        upperButton4 = new LegacyModelRenderer(this, 8, 0);
        ...
        lowerButton8 = new LegacyModelRenderer(this, 0, 9);
        ...
        lowerButton3 = new LegacyModelRenderer(this, 0, 9);
        ...
        upperButton5 = new LegacyModelRenderer(this, 8, 0);
        ...
        lowerButton2 = new LegacyModelRenderer(this, 0, 9);
        ...
        upperButton1 = new LegacyModelRenderer(this, 8, 0);
        ...
        lowerButton4 = new LegacyModelRenderer(this, 0, 9);
        ...
        lowerButton1 = new LegacyModelRenderer(this, 0, 9);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LegacyGL.glScaled(1.15D, 1.15D, 1.15D);
        LegacyGL.glTranslatef(-body1.offsetX, -body1.offsetY, -body1.offsetZ);
        LegacyGL.glTranslatef(-body1.rotationPointX * f5, -body1.rotationPointY * f5, -body1.rotationPointZ * f5);
        body1.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(upperButton1.offsetX, upperButton1.offsetY, upperButton1.offsetZ);
        LegacyGL.glTranslatef(upperButton1.rotationPointX * f5, upperButton1.rotationPointY * f5, upperButton1.rotationPointZ * f5);
        LegacyGL.glScaled(0.3D, 0.3D, 0.3D);
        LegacyGL.glTranslatef(-upperButton1.offsetX, -upperButton1.offsetY, -upperButton1.offsetZ);
        LegacyGL.glTranslatef(-upperButton1.rotationPointX * f5, -upperButton1.rotationPointY * f5, -upperButton1.rotationPointZ * f5);
        upperButton1.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(lowerButton1.offsetX, lowerButton1.offsetY, lowerButton1.offsetZ);
        LegacyGL.glTranslatef(lowerButton1.rotationPointX * f5, lowerButton1.rotationPointY * f5, lowerButton1.rotationPointZ * f5);
        LegacyGL.glScaled(0.3D, 0.3D, 0.3D);
        LegacyGL.glTranslatef(-lowerButton1.offsetX, -lowerButton1.offsetY, -lowerButton1.offsetZ);
        LegacyGL.glTranslatef(-lowerButton1.rotationPointX * f5, -lowerButton1.rotationPointY * f5, -lowerButton1.rotationPointZ * f5);
