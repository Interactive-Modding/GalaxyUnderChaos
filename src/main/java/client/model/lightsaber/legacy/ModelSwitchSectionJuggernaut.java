...
public class ModelSwitchSectionJuggernaut extends LegacyModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        ring1.render(f5);
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(switchButton1.offsetX, switchButton1.offsetY, switchButton1.offsetZ);
        LegacyGL.glTranslatef(switchButton1.rotationPointX * f5, switchButton1.rotationPointY * f5, switchButton1.rotationPointZ * f5);
        LegacyGL.glScaled(1.1D, 0.9D, 0.8D);
        LegacyGL.glTranslatef(-switchButton1.offsetX, -switchButton1.offsetY, -switchButton1.offsetZ);
        LegacyGL.glTranslatef(-switchButton1.rotationPointX * f5, -switchButton1.rotationPointY * f5, -switchButton1.rotationPointZ * f5);
