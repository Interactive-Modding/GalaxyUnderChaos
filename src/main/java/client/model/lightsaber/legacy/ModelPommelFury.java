...
public class ModelPommelFury extends LegacyModelBase
{
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        LegacyGL.glTranslatef(cap1.offsetX, cap1.offsetY, cap1.offsetZ);
        LegacyGL.glTranslatef(cap1.rotationPointX * f5, cap1.rotationPointY * f5, cap1.rotationPointZ * f5);
        ...
        LegacyGL.glScaled(1.05D, 0.7D, 1.05D);
        LegacyGL.glTranslatef(-topRing1.offsetX, -topRing1.offsetY, -topRing1.offsetZ);
        LegacyGL.glTranslatef(-topRing1.rotationPointX * f5, -topRing1.rotationPointY * f5, -topRing1.rotationPointZ * f5);
        topRing1.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(side2_1.offsetX, side2_1.offsetY, side2_1.offsetZ);
        LegacyGL.glTranslatef(side2_1.rotationPointX * f5, side2_1.rotationPointY * f5, side2_1.rotationPointZ * f5);
        ...
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(side4_1.offsetX, side4_1.offsetY, side4_1.offsetZ);
        LegacyGL.glTranslatef(side4_1.rotationPointX * f5, side4_1.rotationPointY * f5, side4_1.rotationPointZ * f5);
        LegacyGL.glScaled(0.23D, 0.23D, 0.23D);
        LegacyGL.glTranslatef(-side4_1.offsetX, -side4_1.offsetY, -side4_1.offsetZ);
        LegacyGL.glTranslatef(-side4_1.rotationPointX * f5, -side4_1.rotationPointY * f5, -side4_1.rotationPointZ * f5);
        side4_1.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(side1_1.offsetX, side1_1.offsetY, side1_1.offsetZ);
        LegacyGL.glTranslatef(side1_1.rotationPointX * f5, side1_1.rotationPointY * f5, side1_1.rotationPointZ * f5);
        ...
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(angledRing1.offsetX, angledRing1.offsetY, angledRing1.offsetZ);
        LegacyGL.glTranslatef(angledRing1.rotationPointX * f5, angledRing1.rotationPointY * f5, angledRing1.rotationPointZ * f5);
        LegacyGL.glScaled(0.85D, 1.4D, 0.85D);
        LegacyGL.glTranslatef(-angledRing1.offsetX, -angledRing1.offsetY, -angledRing1.offsetZ);
        LegacyGL.glTranslatef(-angledRing1.rotationPointX * f5, -angledRing1.rotationPointY * f5, -angledRing1.rotationPointZ * f5);
        angledRing1.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(lowerRing1.offsetX, lowerRing1.offsetY, lowerRing1.offsetZ);
        LegacyGL.glTranslatef(lowerRing1.rotationPointX * f5, lowerRing1.rotationPointY * f5, lowerRing1.rotationPointZ * f5);
        LegacyGL.glScaled(0.9D, 0.7D, 0.9D);
        LegacyGL.glTranslatef(-lowerRing1.offsetX, -lowerRing1.offsetY, -lowerRing1.offsetZ);
        LegacyGL.glTranslatef(-lowerRing1.rotationPointX * f5, -lowerRing1.rotationPointY * f5, -lowerRing1.rotationPointZ * f5);
        lowerRing1.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(side3_1.offsetX, side3_1.offsetY, side3_1.offsetZ);
        LegacyGL.glTranslatef(side3_1.rotationPointX * f5, side3_1.rotationPointY * f5, side3_1.rotationPointZ * f5);
        LegacyGL.glScaled(0.3D, 0.3D, 0.3D);
        LegacyGL.glTranslatef(-side3_1.offsetX, -side3_1.offsetY, -side3_1.offsetZ);
        LegacyGL.glTranslatef(-side3_1.rotationPointX * f5, -side3_1.rotationPointY * f5, -side3_1.rotationPointZ * f5);
        side3_1.render(f5);
        LegacyGL.glPopMatrix();
        LegacyGL.glPushMatrix();
        LegacyGL.glTranslatef(middleRing1.offsetX, middleRing1.offsetY, middleRing1.offsetZ);
        LegacyGL.glTranslatef(middleRing1.rotationPointX * f5, middleRing1.rotationPointY * f5, middleRing1.rotationPointZ * f5);
