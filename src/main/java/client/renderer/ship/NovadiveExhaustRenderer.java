...
public final class NovadiveExhaustRenderer {
    ...
    private NovadiveExhaustRenderer() {
    }

    public static void render(PoseStack poseStack, net.minecraft.client.renderer.MultiBufferSource buffer, NovadiveEntity ship, float partialTick) {
